...
if __name__ == '__main__':
    ...
    print(len(gr.nodes))
    print(len(gr.edges))
    gene_pair = pd.read_csv("label_result816/postive_pair_100_2.csv")
    gene_pair2=pd.read_csv("label_result816/negative_pair_200.csv")
    max_length = 4
    ...
    for pair in gene_pair:
        ...
        rank_pd.to_csv("lab_result816/lab_effectiveness_300.csv",mode='a')
    ...
    re_pd.to_csv("lab_result816/lab_result_effectiveness_300.csv")
    re_strs=pd.DataFrame(re_strs)
    re_strs.to_csv("lab_result816/lab_result_str_300.csv")
    re_rank_percent_pd=pd.DataFrame(re_rank_percent)
    re_rank_percent_pd.to_csv("lab_result816/lab_result_percent_300.csv",mode="a")
